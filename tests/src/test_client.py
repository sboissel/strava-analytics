...
class StravaClientTests(unittest.TestCase):
    ...
    def test_from_env_defaults_data_dir_to_repo_data(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("strava_analytics.client.REPO_ROOT", repo_root), patch.dict(
    ...
    def test_refresh_access_token_stores_token_on_client(self):
        ...
        with patch("strava_analytics.client.requests.post", return_value=mock_response) as post_mock:
    ...
    def test_refresh_access_token_keeps_refresh_token_when_absent(self):
        ...
        with patch("strava_analytics.client.requests.post", return_value=mock_response):
    ...
    def test_get_activities_paginates_until_last_known_activity(self):
        ...
        with patch("strava_analytics.client.requests.get", side_effect=[first_page, second_page]) as get_mock, patch(
            "strava_analytics.client.time.sleep", return_value=None
        ):
    ...
    def test_get_activities_stops_on_empty_page(self):
        ...
        with patch(
            "strava_analytics.client.requests.get", side_effect=[first_page, empty_page]
    ...
    def test_get_streams_refreshes_access_token_when_missing(self):
        ...
        with patch.object(client, "refresh_access_token", side_effect=refresh_side_effect) as refresh_mock, patch(
            "strava_analytics.client.requests.get", return_value=mock_response
        ):
